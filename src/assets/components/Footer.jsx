        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            <h3 className="text-xl font-bold mb-4  text-black">
              WOULD YOU LIKE TO DO A SPONSORED CHARITY EVENT?
            </h3>
            <p className="text-sm mb-4  text-black">
              Whether it’s raising funds from a cake bake or being sponsored for
              a marathon, any money you raise will be put to good use.
            </p>
          ...
          <div className="bg-white text-gray-900 p-6 rounded shadow">
            ...
            <p className="text-sm mb-4">
              Donating helps us make a difference. Minimum admin fees ensure
              donations reach veterans who need it most.
            </p>
            <button className="bg-blue-300  px-4 py-2 rounded  text-black">
              Donate
            </button>
          </div>
        </div>
